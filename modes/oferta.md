...
Lee los masters DOCX (`templates/cv/CV_Gaurav_Kulkarni_EN.docx` o `Lebenslauf_Gaurav_Kulkarni_DE.docx`) vía `python-docx`. Crea tabla con cada requisito del JD mapeado a líneas exactas del CV.
